# binary search over partition range
# imagine making a cut of x elements on small array; automatically (n1+n2+1)//2 - x elements on large array
# partition should be such that elements on left <= elements on right for both arrays 
...
class Solution:
    def findMedianSortedArrays(self, nums1: List[int], nums2: List[int]) -> float:
        ...
        def is_partition_good(x):
            ...
            if n1l > n2r:
                return -1, n1l, n2l, n1r, n2r
            if n2l > n1r:
                return 1, n1l, n2l, n1r, n2r
            return 0, n1l, n2l, n1r, n2r
        ...
        # find median using border elements
