...
# create boundary cell set for each oceans
# loop thru every non-boundary cell for each ocean
# check if the cell can reach the corresponding ocean (DFS/BFS) and add to set
# result would be intersection of set
