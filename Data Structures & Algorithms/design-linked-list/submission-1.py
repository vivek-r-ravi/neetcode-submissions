...
# O(1) for init and addAtHead, O(n) for other functions
...
# singly linked list is represented by a head and a tail
# O(1) for init, addAtTail and addAtHead, O(n) for other functions
# O(n) space complexity
