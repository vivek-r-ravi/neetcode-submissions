...
# O(n) time and O(h) space for init, O(1) time and O(h) space for next and hasNext
class BSTIteratorV1:
...
# canonical: split inorder traversal (iteration) into 3 steps, one for each function
