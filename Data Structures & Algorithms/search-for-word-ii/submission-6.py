...
class TrieNode:
    def __init__(self):
        ...
        self.refs = 0  # number of words passing thru this node
    ...
    def findWords(self, board: List[List[str]], words: List[str]) -> List[str]:
        ...
        def dfs(r, c, trie_node):
            if (
                ...
                or board[r][c] == "#"
                or board[r][c] not in trie_node.children
                or not trie_node.children[board[r][c]]
            ):
                return
            ...
            if trie_node.word_idx != -1:
                ...
                trie_node.refs -= 1  # reduce number of words passing thru node
                if not trie_node.refs:  # if no words passing thru node, delete node
                    prev.children[board[r][c]] = None
                    trie_node = None
                    return
